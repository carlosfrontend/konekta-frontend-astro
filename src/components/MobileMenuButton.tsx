...
export default function MobilemenuButton() {
    ...
    if (!menuIsOpen) {
        return <button onClick={handleClickOpen} className="z-50 md:hidden absolute top-4 right-4 cursor-pointer">
            <svg viewBox="0 0 24 24" fill="#ffffff" className="size-8 z-50">
                <path fillRule="evenodd" d="M3 6.75A.75.75 0 0 1 3.75 6h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 6.75ZM3 12a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 12Zm0 5.25a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75a.75.75 0 0 1-.75-.75Z" clipRule="evenodd" />
            </svg>
        </button>
    }
    return (
        <button onClick={handleClickClose} className="z-50 md:hidden absolute top-4 right-4 cursor-pointer animate-rotate-left duration-1000">
            <svg viewBox="0 0 24 24" fill="#ffffff" className="size-8 z-50">
