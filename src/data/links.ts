...
const GENERIC_CLASS = 'text-lg text-slate-700 transition-transform ease-out hover:scale-110 hover:text-sky-700 inline-block focus:text-sky-700'
...
const GENERIC_CLASS_MOBILE = 'text-2xl text-slate-700 focus:text-sky-700 inline-block'
